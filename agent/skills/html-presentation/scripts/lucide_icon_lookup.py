...
LUCIDE_PATHS = {
    ...
    "external-link": (
        "Navigation",
        "M18 13v6a2 2 0 01-2 2H5a2 2 0 01-2-2V8a2 2 0 012-2h6m4-3h6v6m-11-5 5-5 5-5",
    ),
    # Action
    ...
    "edit": (
        "Action",
        "M11 4H4a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2v-7m-1.5-9.5a2.121 2.121 0 113 3L12 17l-4 1 1-4 9.5-9.5z",
    ),
    "save": (
        "Action",
    ...
    "loader": (
        "Status",
        "M12 2v4m0 12v4m10-10h-4M6 12H2m15.07-7.07l-2.83 2.83M7.76 16.24l-2.83 2.83m12.14 0l-2.83-2.83M7.76 7.76L4.93 4.93",
    ),
    "refresh-cw": (
        "Status",
        "M23 4v6h-6m-6 6v6h6m-9.5-9.5a9 9 0 0114.06-3.54M.5 19.5a9 9 0 0114.06 3.54",
    ),
    # Commerce
    "shopping-cart": (
        "Commerce",
        "M9 22a1 1 0 100-2 1 1 0 000 2zM20 22a1 1 0 100-2 1 1 0 000 2zM1 1h4l2.68 13.39a2 2 0 002 1.61h9.72a2 2 0 002-1.61L23 6H6m2-4h13m-13 0L3.5 18m10 0h5",
    ),
    "credit-card": (
        "Commerce",
    ...
    "database": (
        "Data",
        "M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10zM2 12c0-3.5 2.5-6 6-6m8 6c0-3.5-2.5-6-6-6m-8 6c0-3.5 2.5-6 6-6",
    ),
    ...
    "cloud-off": (
        "Cloud",
        "M22.61 16.95A5 5 0 0018 10h-1.26a8 8 0 00-7.05-5.87M1 1l4 4m0 0l.01.01M5 9a5 5 0 004.73 4.99H9m0 0v.01M1 11.59l4 4m0 0l.01.01",
    ),
    # Social
    "heart": (
        "Social",
    ...
    "users": (
        "Social",
        "M17 21v-2a4 4 0 00-4-4H5a4 4 0 00-4 4v2m22-2v14a2 2 0 01-2 2H7a2 2 0 01-2-2v-14m8 0a4 4 0 01-4 4H9m12 0a4 4 0 01-4-4",
    ),
    "message-circle": (
        "Social",
    ...
    "smile": (
        "Social",
        "M12 22a10 10 0 100-20 10 10 0 000 20zM8 14s1.5 2 4 2 4-2 4-2m-9-4h.01M17 17h.01",
    ),
    # Security
    ...
    "file-text": (
        "Files",
        "M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8zM14 2v7h7M16 13H8m8 4H8m2-8H8",
    ),
    ...
    "mail": (
        "Communication",
        "M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2zm16 2l-8 4-8-4",
    ),
    "phone": (
        "Communication",
    ...
    "user-plus": (
        "User",
        "M16 21v-2a4 4 0 00-4-4H6a4 4 0 00-4 4v2m12-8h.01M12 11a4 4 0 100-8 4 4 0 000 8zM18 8h.01M22 8h.01",
    ),
    ...
    "monitor": (
        "Device",
        "M20 3H4a2 2 0 00-2 2v12a2 2 0 002 2h16a2 2 0 002-2V5a2 2 0 00-2-2zM8 21h8m-4-4v4",
    ),
    "smartphone": (
        "Device",
    ...
    "tablet": (
        "Device",
        "M18 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V4a2 2 0 00-2-2zM12 18h.01",
    ),
    # Location
    "map-pin": (
        "Location",
    ...
    "git-branch": (
        "Development",
        "M6 3v12m0 0a3 3 0 106 0m-6 0a3 3 0 102 0m6-6v3m6-6a3 3 0 11-6 0",
    ),
    # AI / Smart
    "cpu": (
        "Data",
        "M9 3H5a2 2 0 00-2 2v4m6-6h10a2 2 0 012 2v4M9 3v18m0 0h10a2 2 0 002-2V9M9 21H5a2 2 0 01-2-2V9m0 0h18M3 9a2 2 0 012-2h4m10 0h4a2 2 0 012 2v4a2 2 0 01-2 2M3 15a2 2 0 002 2h4m10 0h4a2 2 0 002-2v-4a2 2 0 00-2-2H5",
    ),
    ...
    "building": (
        "Layout",
        "M6 22V4a2 2 0 012-2h8a2 2 0 012 2v18zm0 0H4a2 2 0 01-2-2V9a2 2 0 012-2h1m10 0h6m0 0v5m0-5h-6v5",
    ),
    "settings": (
        "Action",
    ...
    "truck": (
        "Commerce",
        "M5 17H3a2 2 0 01-2-2V5a2 2 0 012-2h11v12H5zm14 0h2a2 2 0 012 2v4a2 2 0 01-2 2h-2m-4 0H9v-6h6v6zM5 17a2 2 0 104 0m14 0a2 2 0 11-4 0",
    ),
    "shield-check": (
        "Security",
    ...
    "award": (
        "Social",
        "M12 15l-3 6 1.5-4.5L7.5 18h9L13.5 16.5 15 18l-3-6zM8.21 3.79l-.56-.53L4 7.39l1.22 2.73 3.5 1 2.12-3.56L8.79 3.21 12 2l3.21 1.21 2.47 3.95 2.12 3.56 3.5-1 1.22-2.73-3.65-4.26-.56.53L12 2 8.21 3.79z",
    ),
    "star": (
        "Social",
    ...
    "clipboard": (
        "Action",
        "M16 4h2a2 2 0 012 2v14a2 2 0 01-2 2H6a2 2 0 01-2-2V6a2 2 0 012-2h2m8 0h.01M9 10h.01M15 10h.01",
    ),
    "inbox": (
        "Communication",
        "M5 7h14l-1.5 9H6.5L5 7zm0 0V5a2 2 0 012-2h10a2 2 0 012 2v2m-14 0h14",
    ),
    "send": ("Communication", "M22 2L11 13M22 2l-7 20-4-9-9-4 20-7z"),
}


def get_svg(name: str, size: int = 24, stroke: str = "currentColor", stroke_width: float = 2) -> str:
    """返回图标的 inline SVG 代码"""
...
def list_icons():
    """从内置图标库读取所有图标"""
    return [
        {"Icon Name": name, "Category": cat, "Keywords": "", "Usage": ""} for name, (cat, _) in LUCIDE_PATHS.items()
    ]
...
def search(query: str):
    ...
    results = [
        i
        for i in icons
        if query in i["Icon Name"].lower() or query in i["Keywords"].lower() or query in i["Category"].lower()
    ]
    if not results:
...
def random_icon():
    ...
    priority = [i for i in icons if i["Category"] in ("Action", "Status", "Navigation", "Commerce", "Social")]
    if not priority:
        priority = icons
