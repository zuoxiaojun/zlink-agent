...
class Config:
    ...
    GATEWAY_URL: str = os.getenv(
        'YONSUITE_GATEWAY_URL',
        'https://c2.yonyoucloud.com/iuap-api-gateway'
    )
    TOKEN_URL: str = os.getenv(
        'YONSUITE_TOKEN_URL',
        'https://c2.yonyoucloud.com/iuap-api-auth'
    )
    DEFAULT_TOKEN_URL: str = os.getenv(
        'YONSUITE_DEFAULT_TOKEN_URL',
        'https://c2.yonyoucloud.com/iuap-api-auth'
    )
