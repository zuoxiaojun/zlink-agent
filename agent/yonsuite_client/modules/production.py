...
class ProductionModule(BaseAPIClient):
    ...
    def get_order_detail_parsed(self, access_token: str, order_id: str) -> Optional[ProductionOrderDetail]:
        """
        查询生产订单详情（解析为模型对象）
    ...
    @retry_on_failure()
    def query_production_orders_batch(self, access_token: str,
    ...
    def query_production_orders_batch_parsed(self, access_token: str,
                                             order_ids: List[str],
                                             show_process: bool = False,
                                             show_material: bool = False,
                                             show_by_product: bool = False) -> List[ProductionOrderDetail]:
        """
        批量查询生产订单详情（解析为模型对象）
