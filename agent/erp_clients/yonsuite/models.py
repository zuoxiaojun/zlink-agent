...
class PurchaseOrder(BaseModel):
    ...
    def from_api(cls, data: dict[str, Any]) -> "PurchaseOrder":
        ...
        return cls(
            ...
            purchase_qty=safe_float(
                get_purchase_field("purchaseOrders", "priceQty")
                or data.get("priceQty")
                or data.get("purchaseOrders_priceQty")
            ),
            ...
            total_invoicenum=safe_float(
                data.get("purchaseOrders_invStatus") or data.get("purchaseOrders_invoiceStatus")
            ),
            memo=safe_str(data.get("memo")),
            created_time=safe_str(data.get("createTime")),
            modified_time=safe_str(data.get("modifyTime")),
...
class ProductionOrder(BaseModel):
    ...
    def from_api(cls, data: dict[str, Any]) -> "ProductionOrder":
        ...
        return cls(
            ...
            free_chars=safe_str(get_op("propCharacteristics"))
            if isinstance(get_op("propCharacteristics"), str)
            else "",
