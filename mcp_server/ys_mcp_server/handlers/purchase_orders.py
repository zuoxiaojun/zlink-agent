...
from ..constants import PURCHASE_STATUS_MAP, PURCHASE_ARRIVED_MAP, PURCHASE_INWH_MAP, PURCHASE_INVOICE_MAP
...
def handle(client, arguments: dict) -> dict:
    ...
    for r in records:
        ...
        parsed.append({
            ...
            "qty": r2(r.get("subQty", 0)), "unitPrice": r2(r.get("oriTaxUnitPrice", 0)),
            "listOriSum": r2(list_ori_sum), "tax": r2(r.get("listOriTax", 0)),
